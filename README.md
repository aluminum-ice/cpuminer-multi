 ...
 * ✓ __curvehash__ (Curvehash [CURVE], PulsarCoin [PLSR])
...
Download
========
 * Git tree:   https://github.com/rumahcode/cpuminer-rc
   * Clone with `git clone https://github.com/rumahcode/cpuminer-rc`
